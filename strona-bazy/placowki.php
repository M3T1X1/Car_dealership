...
<body>
    ...
    <button id="count-positions-button">Oblicz ilość pracowników</button>
    ...
    <table id="placowki-table">
        ...
        <?php
            ...
            try {
                ...
                $sql = 'SELECT * FROM "Placowki".pobierz_placowki() ORDER BY "id_placowki";';
    ...
    <script>
        ...
        document.getElementById("count-positions-button").addEventListener("click", function () {
            ...
            fetch(`ilosc_pracownikow.php?placowkaid=${placowkaId}`)
